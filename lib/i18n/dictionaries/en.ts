...
export const en = {
  ...
  pages: {
    community: {
      ...
      titleLabel: "Title",
      titlePlaceholder: "What should the community know?",
      bodyLabel: "Message",
      bodyPlaceholder: "Add useful context, details, or a question…",
      publish: "Publish",
      publishing: "Publishing…",
      cancel: "Cancel",
      announcement: "Official announcement",
      comments: (count: number) => `${n(count)} ${count === 1 ? "comment" : "comments"}`,
      addComment: "Add a comment",
      commentPlaceholder: "Write a constructive reply…",
      reply: "Comment",
      emptyTitle: "No community posts yet",
      emptyBody: "Start the first discussion and help neighbours find reliable land information.",
      loadError: "The community feed could not be loaded.",
      postError: "Your post could not be published.",
      commentError: "Your comment could not be added.",
      voteError: "Your vote could not be saved.",
      postType: "Post type",
      upVote: "Up vote",
      downVote: "Down vote",
      votes: (score: number) => `${n(score)} votes`,
    },
    application: {
