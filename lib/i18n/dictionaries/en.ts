...
export const en = {
  ...
  pages: {
    ...
    leaseSettlement: {
      ...
      emptyTitle: "No lease applications",
      emptyBody: "You haven't applied for any lease or settlement yet.",
    ...
    mutations: {
      ...
      verificationCompletedBody: "The objection period is now recorded.",
