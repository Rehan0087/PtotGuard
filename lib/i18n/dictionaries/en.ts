  ...
  pages: {
    ...
    mutations: {
      ...
      hold: {
        ...
        noRecipient:
          "This request was filed before recipients had to be a registered account — it can be rejected, but not approved.",
      },
    ...
    newMutation: {
      ...
      toOwnerLabel: "New owner",
      toOwnerPlaceholder: "Search by email or phone",
      ...
      errors: {
        ...
        toOwnerRequired: "Search for and select the new owner's account.",
      },
    },
    ...
    leaseSettlement: {
      description:
        "Apply for settlement of khas (government) land, agricultural or non-agricultural.",
      newRequest: "New application",
      landUse: {
        agricultural: "Agricultural",
        agriculturalBlurb: "Farming land — cultivation, fisheries, and similar uses.",
        nonAgricultural: "Non-agricultural",
        nonAgriculturalBlurb: "Homestead, commercial, or other non-farming use.",
      },
      locationDescriptionLabel: "Location of the land",
      locationDescriptionPlaceholder: "Mouza, plot description, and any landmarks",
      areaLabel: "Area (decimals)",
      termLabel: "Requested term (years)",
      purposeLabel: "Purpose",
      purposePlaceholder: "What you intend to use the land for",
      ...
      appliedBody: (applicationNo: string) =>
        `${applicationNo} has been recorded and sent for review.`,
      failedTitle: "Application could not be submitted",
      failedBody: "Please try again.",
      myRequestsLabel: "Your applications",
      emptyTitle: "No applications yet",
      emptyBody: "Lease and settlement applications you file will appear here.",
      queueTitle: "Applications awaiting decision",
      queueEmptyTitle: "Nothing awaiting a decision",
      queueEmptyBody: "Settlement applications will appear here once citizens file them.",
      approve: "Approve",
      reject: "Reject",
      ...
      closed: "Decided",
      errors: {
        locationDescriptionRequired: "Describe where the land is.",
        areaRequired: "Enter the area you're applying for.",
        termRequired: "Enter the term you're requesting.",
        purposeRequired: "State what you intend to use the land for.",
      },
    },

    acquisition: {
      description:
        "Notices affecting land you own, the compensation award attached to each, and a place to object.",
      officerDescription:
        "Issue an acquisition notice against a parcel for a public purpose, naming a compensation award.",
      newNotice: "Issue notice",
      parcelSearchLabel: "Parcel",
      parcelSearchPlaceholder: "Search by dag number, owner, or title",
      parcelSearchEmpty: "No matching parcels.",
      purposeLabel: "Public purpose",
      purposePlaceholder: "e.g. road widening, embankment, a public building",
      awardAmountLabel: "Compensation award",
      issue: "Issue notice",
      issuedTitle: "Notice issued",
      issuedBody: (applicationNo: string) => `${applicationNo} has been recorded against the parcel.`,
      failedTitle: "Notice could not be issued",
      failedBody: "Please try again.",
      myNoticesLabel: "Notices on your land",
      emptyTitle: "No notices on record",
      emptyBody: "Acquisition or requisition notices affecting your land will appear here.",
      queueTitle: "Notices issued",
      queueEmptyTitle: "No notices issued yet",
      queueEmptyBody: "Acquisition notices you issue will appear here.",
      awardLabel: "Compensation award",
      awardedLabel: "Compensation awarded",
      withdrawnLabel: "Notice withdrawn",
      objectionLabel: "Your objection",
      objectionPlaceholder: "State why this acquisition should not proceed, or should proceed differently",
      fileObjection: "File objection",
      objectionFiledTitle: "Objection filed",
      objectionFailedTitle: "Objection could not be filed",
      yourObjectionLabel: "Your objection",
      approve: "Approve",
      reject: "Reject",
      approvedTitle: "Notice approved",
      rejectedTitle: "Notice withdrawn",
      closed: "Decided",
      errors: {
        parcelRequired: "Choose a parcel.",
        purposeRequired: "State the public purpose for this acquisition.",
