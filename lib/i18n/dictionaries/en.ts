...
export const en = {
  ...
  pages: {
    ...
    capture: {
      ...
      disputeDescription: "Describe the dispute for the mediator case",
      filing: "Filing…",
      filed: "Report filed.",
    ...
    mutations: {
      ...
      hold: {
        ...
        mediationPending: "The field dispute is with the mediator. A final mutation decision is locked until the ruling arrives.",
        mediationUnresolved: "Mediation did not resolve the dispute. Reject this mutation with the mediator's ruling as the reason.",
      },
      ...
      mediationCase: (caseNumber: string, status: string) => `Mediator case ${caseNumber} · ${status}`,
    ...
    landTax: {
      ...
      officer: {
        description: "Assess annual land revenue, collect tax from landowners, and maintain a receipt register for every holding in your jurisdiction.",
