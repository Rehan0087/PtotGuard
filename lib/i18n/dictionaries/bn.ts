...
export const bn: Dictionary = {
  ...
  pages: {
    ...
    fieldProfile: {
      ...
      avatarUrl: "প্রোফাইল ছবির ইউআরএল",
      avatarHint: "HTTPS ছবির ঠিকানা ব্যবহার করুন। ফাঁকা রাখলে নামের আদ্যক্ষর দেখাবে।",
      ...
      errors: {
        ...
        avatarUrl: "সঠিক HTTP বা HTTPS ছবির ঠিকানা লিখুন।",
