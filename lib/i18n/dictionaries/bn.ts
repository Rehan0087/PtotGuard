...
export const bn: Dictionary = {
  ...
  pages: {
    ...
    revenueCases: {
      ...
      approve: "অনুমোদন করুন",
      reject: "প্রত্যাখ্যান করুন",
      approvedTitle: "মামলা অনুমোদিত",
      rejectedTitle: "মামলা প্রত্যাখ্যাত",
      closed: "বন্ধ",
    ...
    mutations: {
      ...
      hold: {
        ...
        mediationPending: "মাঠ পর্যায়ের বিরোধটি মধ্যস্থতাকারীর কাছে রয়েছে। রায় না আসা পর্যন্ত চূড়ান্ত নামজারি সিদ্ধান্ত বন্ধ থাকবে।",
        mediationUnresolved: "মধ্যস্থতায় বিরোধ নিষ্পত্তি হয়নি। মধ্যস্থতাকারীর রায় উল্লেখ করে নামজারিটি প্রত্যাখ্যান করুন।",
      },
    ...
    landTax: {
      ...
      officer: {
        description: "আপনার অধিক্ষেত্রের প্রতিটি হোল্ডিংয়ের বার্ষিক ভূমি রাজস্ব নির্ধারণ, ভূমি মালিকদের কাছ থেকে কর সংগ্রহ এবং দাখিলার রেকর্ড সংরক্ষণ করুন।",
