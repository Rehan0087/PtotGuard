...
export const bn: Dictionary = {
  ...
  status: {
    ...
    serviceApplication: {
      ...
      "under-review": "পর্যালোচনাধীন",
      "field-investigation": "সরেজমিন তদন্ত",
      "hearing-scheduled": "শুনানি নির্ধারিত",
      approved: "অনুমোদিত",
      rejected: "প্রত্যাখ্যাত",
  ...
  pages: {
    ...
    mutations: {
      ...
      hold: {
        ...
        noRecipient:
          "গ্রহীতাকে নিবন্ধিত অ্যাকাউন্ট হতে হবে — এই নিয়মের আগে দাখিল হওয়া এই আবেদনটি প্রত্যাখ্যান করা যাবে, অনুমোদন করা যাবে না।",
      },
    ...
    newMutation: {
      ...
      toOwnerLabel: "নতুন মালিক",
      toOwnerPlaceholder: "ইমেইল বা ফোন নম্বর দিয়ে খুঁজুন",
      ...
      errors: {
        ...
        toOwnerRequired: "নতুন মালিকের অ্যাকাউন্ট খুঁজে নির্বাচন করুন।",
      },
    },
    ...
    landAdmin: {
      description:
        "আপনার জমির রেকর্ডের সহিমোহরি নকল আবেদন করুন, অথবা রেকর্ডে থাকা কোনো ভুল — যেমন নামের বানান বা আয়তনের ভুল — সংশোধনের জন্য আবেদন করুন।",
      newRequest: "নতুন আবেদন",
      requestType: {
        certifiedCopy: "সহিমোহরি নকল",
        certifiedCopyBlurb: "আপনার দাগের রেকর্ডের একটি সরকারি সিলমোহরযুক্ত ও তারিখযুক্ত কপি।",
        correction: "সংশোধন",
        correctionBlurb: "রেকর্ডে থাকা কোনো ভুল সংশোধন — নামের বানান, আয়তন, বা অনুরূপ কিছু।",
      },
      parcelLabel: "দাগ",
      parcelPlaceholder: "একটি দাগ নির্বাচন করুন",
      correctionTypeLabel: "কী সংশোধন প্রয়োজন?",
      correctionType: {
        name: "নাম",
        area: "আয়তন",
        other: "অন্যান্য",
      },
      currentValueLabel: "রেকর্ডে বর্তমানে যা আছে",
      correctedValueLabel: "যা হওয়া উচিত",
      reasonLabel: "সংশোধনের কারণ",
      reasonPlaceholder: "কী ভুল এবং কেন তা ব্যাখ্যা করুন",
      feeLabel: "ফি",
      pay: "পরিশোধ করে জমা দিন",
      confirmPay: (amount: string) => `${amount} পরিশোধ করুন`,
      paymentNote:
        "এটি প্রদর্শনের জন্য অনুকরণকৃত পরিশোধ — কোনো অর্থ স্থানান্তরিত হয় না এবং কোনো পরিশোধের তথ্য সংগ্রহ করা হয় না।",
      paymentMethods: { bkash: "বিকাশ", nagad: "নগদ", card: "কার্ড" },
      appliedTitle: "আবেদন জমা হয়েছে",
      appliedBody: (applicationNo: string) => `${applicationNo} নথিভুক্ত হয়েছে এবং পর্যালোচনার জন্য পাঠানো হয়েছে।`,
      failedTitle: "আবেদন জমা দেওয়া যায়নি",
      failedBody: "অনুগ্রহ করে আবার চেষ্টা করুন।",
      myRequestsLabel: "আপনার আবেদনসমূহ",
      emptyTitle: "এখনো কোনো আবেদন নেই",
      emptyBody: "আপনার জমা দেওয়া সহিমোহরি নকল ও সংশোধনের আবেদন এখানে দেখা যাবে।",
      queueTitle: "সিদ্ধান্তের অপেক্ষায় থাকা আবেদন",
      queueEmptyTitle: "সিদ্ধান্তের অপেক্ষায় কিছু নেই",
      queueEmptyBody: "নাগরিকরা আবেদন জমা দিলে সহিমোহরি নকল ও সংশোধনের আবেদন এখানে দেখা যাবে।",
      approve: "অনুমোদন করুন",
      reject: "প্রত্যাখ্যান করুন",
      approvedTitle: "আবেদন অনুমোদিত হয়েছে",
      rejectedTitle: "আবেদন প্রত্যাখ্যাত হয়েছে",
      closed: "সিদ্ধান্ত হয়েছে",
      errors: {
        parcelRequired: "একটি দাগ নির্বাচন করুন।",
        correctionTypeRequired: "কী সংশোধন প্রয়োজন তা নির্বাচন করুন।",
        currentValueRequired: "রেকর্ডে বর্তমানে কী আছে তা লিখুন।",
        correctedValueRequired: "এর বদলে কী হওয়া উচিত তা লিখুন।",
        reasonRequired: "এই সংশোধনের কারণ ব্যাখ্যা করুন।",
      },
    },

    revenueCases: {
      description: "রাজস্ব আদালতে বিবিধ মামলা বা আপিল দায়ের করুন এবং সিদ্ধান্ত পর্যন্ত অগ্রগতি দেখুন।",
      newCase: "নতুন মামলা",
      caseType: {
        miscellaneous: "বিবিধ মামলা",
        miscellaneousBlurb:
          "অন্য কোথাও অন্তর্ভুক্ত নয় এমন বিষয়ে লিখিত আরজি — রেকর্ড এন্ট্রি, শ্রেণিবিন্যাস, বা অনুরূপ কিছু।",
        appeal: "আপিল",
        appealBlurb:
          "আপনার বিরুদ্ধে দেওয়া কোনো সিদ্ধান্তের বিরুদ্ধে আপিল করুন, কী সিদ্ধান্ত এবং কেন তা পুনর্বিবেচনা করা উচিত তা উল্লেখ করে।",
      },
      parcelLabel: "দাগ",
      parcelPlaceholder: "একটি দাগ নির্বাচন করুন",
      groundsLabel: "বিবরণ",
      groundsPlaceholder: "ঘটনা এবং আপনি কী চাইছেন তা উল্লেখ করুন",
      againstReferenceLabel: "যে সিদ্ধান্তের বিরুদ্ধে আপিল করছেন তার রেফারেন্স",
      againstReferencePlaceholder: "যেমন একটি স্মারক বা আদেশ নম্বর",
      feeLabel: "দাখিলা ফি",
      pay: "পরিশোধ করে দাখিল করুন",
      confirmPay: (amount: string) => `${amount} পরিশোধ করুন`,
      paymentNote:
        "এটি প্রদর্শনের জন্য অনুকরণকৃত পরিশোধ — কোনো অর্থ স্থানান্তরিত হয় না এবং কোনো পরিশোধের তথ্য সংগ্রহ করা হয় না।",
      paymentMethods: { bkash: "বিকাশ", nagad: "নগদ", card: "কার্ড" },
      filedTitle: "মামলা দাখিল হয়েছে",
      filedBody: (applicationNo: string) =>
        `${applicationNo} নথিভুক্ত হয়েছে এবং পর্যালোচনার জন্য পাঠানো হয়েছে।`,
      failedTitle: "মামলা দাখিল করা যায়নি",
      failedBody: "অনুগ্রহ করে আবার চেষ্টা করুন।",
      myCasesLabel: "আপনার মামলাসমূহ",
      emptyTitle: "এখনো কোনো মামলা নেই",
      emptyBody: "আপনার দাখিল করা মামলা এখানে দেখা যাবে।",
      hearingAtLabel: (date: string) => `${date} তারিখে শুনানি`,
      queueTitle: "সিদ্ধান্তের অপেক্ষায় থাকা মামলা",
      queueEmptyTitle: "সিদ্ধান্তের অপেক্ষায় কিছু নেই",
      queueEmptyBody: "নাগরিকরা দাখিল করলে বিবিধ মামলা ও আপিল এখানে দেখা যাবে।",
      scheduleHearing: "শুনানি নির্ধারণ করুন",
      hearingDateLabel: "শুনানির তারিখ",
      confirmScheduleHearing: "নিশ্চিত করুন",
      approve: "অনুমোদন করুন",
      reject: "প্রত্যাখ্যান করুন",
      approvedTitle: "মামলা অনুমোদিত হয়েছে",
      rejectedTitle: "মামলা প্রত্যাখ্যাত হয়েছে",
      closed: "সিদ্ধান্ত হয়েছে",
      errors: {
        parcelRequired: "একটি দাগ নির্বাচন করুন।",
        groundsRequired: "এই মামলার বিবরণ উল্লেখ করুন।",
        againstReferenceRequired: "আপনি কী আপিল করছেন তা লিখুন।",
        hearingDateRequired: "একটি শুনানির তারিখ নির্বাচন করুন।",
      },
    },

    leaseSettlement: {
      description: "কৃষি বা অকৃষি খাস (সরকারি) জমির বন্দোবস্তের জন্য আবেদন করুন।",
      newRequest: "নতুন আবেদন",
      landUse: {
        agricultural: "কৃষি",
        agriculturalBlurb: "চাষাবাদ, মৎস্য চাষ এবং অনুরূপ কৃষিকাজের জন্য জমি।",
        nonAgricultural: "অকৃষি",
        nonAgriculturalBlurb: "বসতবাড়ি, ব্যবসা, বা অন্যান্য অকৃষি ব্যবহারের জন্য।",
      },
      locationDescriptionLabel: "জমির অবস্থান",
      locationDescriptionPlaceholder: "মৌজা, দাগের বিবরণ এবং যেকোনো চিহ্ন",
      areaLabel: "আয়তন (শতক)",
      termLabel: "আবেদনকৃত মেয়াদ (বছর)",
      purposeLabel: "উদ্দেশ্য",
      purposePlaceholder: "জমিটি আপনি কী কাজে ব্যবহার করতে চান",
      feeLabel: "আবেদন ফি",
      pay: "পরিশোধ করে জমা দিন",
      confirmPay: (amount: string) => `${amount} পরিশোধ করুন`,
      paymentNote:
      ...
      myRequestsLabel: "আপনার আবেদনসমূহ",
      emptyTitle: "এখনো কোনো আবেদন নেই",
      emptyBody: "আপনার জমা দেওয়া ইজারা ও বন্দোবস্তের আবেদন এখানে দেখা যাবে।",
      queueTitle: "সিদ্ধান্তের অপেক্ষায় থাকা আবেদন",
      queueEmptyTitle: "সিদ্ধান্তের অপেক্ষায় কিছু নেই",
      queueEmptyBody: "নাগরিকরা আবেদন জমা দিলে বন্দোবস্তের আবেদন এখানে দেখা যাবে।",
      approve: "অনুমোদন করুন",
      reject: "প্রত্যাখ্যান করুন",
      approvedTitle: "আবেদন অনুমোদিত হয়েছে",
      rejectedTitle: "আবেদন প্রত্যাখ্যাত হয়েছে",
      closed: "সিদ্ধান্ত হয়েছে",
      errors: {
        locationDescriptionRequired: "জমিটি কোথায় তা লিখুন।",
        areaRequired: "আপনি যে আয়তনের জন্য আবেদন করছেন তা লিখুন।",
        termRequired: "আপনি যে মেয়াদের জন্য আবেদন করছেন তা লিখুন।",
        purposeRequired: "জমিটি আপনি কী কাজে ব্যবহার করতে চান তা উল্লেখ করুন।",
      },
    },

    acquisition: {
      description: "আপনার মালিকানাধীন জমি সংক্রান্ত নোটিশ, প্রতিটির সাথে যুক্ত ক্ষতিপূরণের রোয়েদাদ, এবং আপত্তি জানানোর সুযোগ।",
      officerDescription: "জনস্বার্থে কোনো দাগের বিরুদ্ধে অধিগ্রহণ নোটিশ জারি করুন, ক্ষতিপূরণের রোয়েদাদসহ।",
      newNotice: "নোটিশ জারি করুন",
      parcelSearchLabel: "দাগ",
      parcelSearchPlaceholder: "দাগ নম্বর, মালিক, বা শিরোনাম দিয়ে খুঁজুন",
      parcelSearchEmpty: "কোনো মিলযুক্ত দাগ পাওয়া যায়নি।",
      purposeLabel: "জনস্বার্থের কারণ",
      purposePlaceholder: "যেমন রাস্তা প্রশস্তকরণ, বাঁধ, বা সরকারি স্থাপনা",
      awardAmountLabel: "ক্ষতিপূরণের রোয়েদাদ",
      issue: "নোটিশ জারি করুন",
      issuedTitle: "নোটিশ জারি হয়েছে",
      issuedBody: (applicationNo: string) => `${applicationNo} দাগের বিরুদ্ধে নথিভুক্ত হয়েছে।`,
      failedTitle: "নোটিশ জারি করা যায়নি",
      failedBody: "অনুগ্রহ করে আবার চেষ্টা করুন।",
      myNoticesLabel: "আপনার জমির নোটিশ",
      emptyTitle: "কোনো নোটিশ নেই",
      emptyBody: "আপনার জমি সংক্রান্ত অধিগ্রহণ বা হুকুমদখল নোটিশ এখানে দেখা যাবে।",
      queueTitle: "জারি করা নোটিশ",
      queueEmptyTitle: "এখনো কোনো নোটিশ জারি হয়নি",
      queueEmptyBody: "আপনার জারি করা অধিগ্রহণ নোটিশ এখানে দেখা যাবে।",
      awardLabel: "ক্ষতিপূরণের রোয়েদাদ",
      awardedLabel: "ক্ষতিপূরণ প্রদত্ত",
      withdrawnLabel: "নোটিশ প্রত্যাহৃত",
      objectionLabel: "আপনার আপত্তি",
      objectionPlaceholder: "এই অধিগ্রহণ কেন হওয়া উচিত নয়, বা ভিন্নভাবে হওয়া উচিত তা উল্লেখ করুন",
      fileObjection: "আপত্তি দাখিল করুন",
      objectionFiledTitle: "আপত্তি দাখিল হয়েছে",
      objectionFailedTitle: "আপত্তি দাখিল করা যায়নি",
      yourObjectionLabel: "আপনার আপত্তি",
      approve: "অনুমোদন করুন",
      reject: "প্রত্যাখ্যান করুন",
      approvedTitle: "নোটিশ অনুমোদিত হয়েছে",
      rejectedTitle: "নোটিশ প্রত্যাহার করা হয়েছে",
      closed: "সিদ্ধান্ত হয়েছে",
      errors: {
        parcelRequired: "একটি দাগ নির্বাচন করুন।",
        purposeRequired: "এই অধিগ্রহণের জনস্বার্থের কারণ উল্লেখ করুন।",
  ...
  landing: {
    ...
    eyebrow: "ডিজিটাল ভূমি রেকর্ড",
    heroTitle: "সঠিকভাবে সম্পন্ন ভূমি রেকর্ড।",
    heroBody:
      "দাগ খুঁজুন, বিরোধ ও নামজারি দাখিল করুন, ভূমি কর পরিশোধ করুন, এবং প্রতিটি ধাপ অনুসরণ করুন — নাগরিক, ভূমি অফিস, মাঠকর্মী, মধ্যস্থতাকারী ও প্রশাসন সবাই এক ব্যবস্থায়।",
    statServices: "ভূমি সেবা",
    statRoles: "ভূমিকাভিত্তিক কার্যপ্রবাহ",
    statAuditValue: "হ্যাশ-চেইনযুক্ত",
    statAudit: "নিরীক্ষা লেজার",
    statBilingual: "ইন্টারফেস ভাষা",
    servicesTitle: "সব সেবা, এক জায়গায়",
    servicesBody:
      "বিক্রয়ের পর নামজারি থেকে শুরু করে রেকর্ডের সত্যায়িত অনুলিপি পর্যন্ত — খুঁজতে, দাখিল করতে, পরিশোধ করতে ও অনুসরণ করতে সাইন ইন করুন।",
    rolesTitle: "ভূমি অফিস যেভাবে কাজ করে, সেভাবেই তৈরি",
    rolesBody:
      "প্রতিটি ভূমিকা শুধু তার কাজের জন্য প্রয়োজনীয় অংশটুকু দেখে — দাখিল, যাচাই, মাঠকর্ম, বিচার বা প্রশাসন।",
    roleBlurbs: {
      citizen: "রেকর্ড খুঁজুন, উত্তরাধিকার অংশ হিসাব করুন, বিরোধ ও নামজারি দাখিল করুন, প্রতিটি মামলা অনুসরণ করুন।",
      "land-office": "দলিল ডিজিটাইজ ও যাচাই করুন, জালিয়াতির অভিযোগ পর্যালোচনা করুন, নামজারি ও আবেদনের সিদ্ধান্ত নিন।",
      "field-agent": "মাঠ পর্যায়ে জিপিএস সীমানা জরিপ করুন এবং ছবি ও পয়েন্ট আকারে প্রমাণ দাখিল করুন।",
      mediator: "শুনানি নিন, উপস্থিতি ও সাক্ষ্য লিপিবদ্ধ করুন, বাধ্যতামূলক রায় দিন।",
      admin: "অ্যাকাউন্ট ও এখতিয়ার পরিচালনা করুন, ফি ও সীমা নির্ধারণ করুন, নিরীক্ষা লেজার তদারকি করুন।",
    },
    trustEyebrow: "নকশা অনুযায়ী পরিবর্তন-প্রতিরোধী",
    trustTitle: "প্রতিটি সিদ্ধান্তের একটি চিহ্ন থেকে যায়",
    trustBody:
      "প্রতিটি তৈরি, অনুমোদন, প্রত্যাখ্যান ও রায় একটি সংযোজন-শুধু, হ্যাশ-চেইনযুক্ত লেজারে লেখা হয় — প্রতিটি এন্ট্রি তার আগেরটির সাথে যুক্ত, ফলে পুরো ইতিহাস শুধু বিশ্বাস নয়, শুরু থেকে শেষ পর্যন্ত যাচাই করা যায়।",
    trustSteps: [
      { title: "একটি কাজ ঘটে", body: "একটি দলিল যাচাই হয়, একটি নামজারি অনুমোদিত হয়, একটি রায় দেওয়া হয়।" },
      { title: "এটি লেজারে যুক্ত হয়", body: "আগের এন্ট্রির হ্যাশসহ লিপিবদ্ধ হয় — অলক্ষ্যে কিছু ঢুকে পড়ার সুযোগ নেই।" },
      { title: "যে কেউ যাচাই করতে পারে", body: "শুরু থেকে শেষ পর্যন্ত চেইন অনুসরণ করে নিশ্চিত হওয়া যায় কিছু পরিবর্তিত হয়নি।" },
    ],
    ctaTitle: "শুরু থেকে শেষ পর্যন্ত দেখুন",
    ctaBody: "একটি ডেমো অ্যাকাউন্ট দিয়ে সাইন ইন করুন এবং দাখিল থেকে সিদ্ধান্ত পর্যন্ত একটি রেকর্ড অনুসরণ করুন।",
  },
};
