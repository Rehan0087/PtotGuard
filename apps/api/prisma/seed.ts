...
async function main(): Promise<void> {
  ...
  await prisma.khasLandPlot.createMany({
    data: [
      ...
      { id: "klp-4", mouza: "Payalgacha", upazila: "Barura", district: "Cumilla", dagNo: "225", landUse: "non-agricultural", areaDecimals: 8, centroidLat: 23.362, centroidLng: 91.032, boundaryGeoJson: square({ lat: 23.362, lng: 91.032 }), status: "reserved", unitPricePerYear: 120 },
      { id: "klp-5", mouza: "Debidwar", upazila: "Debidwar", district: "Cumilla", dagNo: "45", landUse: "non-agricultural", areaDecimals: 5, centroidLat: 23.555, centroidLng: 90.985, boundaryGeoJson: square({ lat: 23.555, lng: 90.985 }), status: "leased", unitPricePerYear: 150 },
  ...
  await prisma.appNotification.createMany({
    data: [
      ...
      { id: "n-6", userId: "usr-ayesha", at: new Date("2026-07-10T08:05:00Z"), severity: "success", title: "Welcome to VhumiShetu", body: "Your account is active. You can now search records and track disputes.", content: { code: "welcome" }, read: true },
