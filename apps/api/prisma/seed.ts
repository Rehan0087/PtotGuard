...
async function main(): Promise<void> {
  ...
  await prisma.mutation.createMany({
    data: [
      ...
      { id: "m-d2-1", mutationNumber: "MUT-2026-01240", parcelId: "p-d2-1", parcelDagNo: "RS-601", type: "inheritance", status: "submitted", fromOwnerName: "Fatema Begum", fromOwnerId: "usr-fatema", toOwnerId: "usr-fatema", toOwnerName: "Fatema Begum", requestedById: "usr-fatema", requestedAt: new Date("2026-09-10T10:00:00Z"), documentIds: [], objections: [], fee: { amount: 5400, currency: "BDT" }, metadata: { heirRelationship: "Daughter" }, createdAt: new Date("2026-09-10T10:00:00Z"), updatedAt: new Date("2026-09-10T10:00:00Z") },
      // Rashed: Correction with correction reason metadata
      { id: "m-d3-1", mutationNumber: "MUT-2026-01241", parcelId: "p-d3-1", parcelDagNo: "RS-701", type: "correction", status: "under-primary-verification", fromOwnerName: "Rashed Khan", fromOwnerId: "usr-rashed", toOwnerId: "usr-rashed", toOwnerName: "Rashed Khan", requestedById: "usr-rashed", requestedAt: new Date("2026-09-08T09:00:00Z"), assignedOfficerId: "usr-officer", verificationStartedAt: new Date("2026-09-09T09:00:00Z"), verificationStartedById: "usr-officer", verificationNotes: "Checking the name spelling error in the khatian.", verificationChecklist: { applicantVerified: true, previousOwnerVerified: true, proposedOwnerVerified: true, dagKhatianVerified: true, deedVerified: false, landRecordMatched: true, documentsPresent: false, khajnaReceiptVerified: false }, documentIds: [], objections: [], fee: { amount: 5400, currency: "BDT" }, metadata: { correctionReason: "Owner name misspelled as 'Rashed Kahan' in the original khatian entry. Correct spelling is Rashed Khan as per NID." }, createdAt: new Date("2026-09-08T09:00:00Z"), updatedAt: new Date("2026-09-09T09:00:00Z") },
      // Noor: Sale (buying from Shanti)
      { id: "m-d4-1", mutationNumber: "MUT-2026-01242", parcelId: "p-d4-1", parcelDagNo: "BS-301", type: "sale", status: "submitted", fromOwnerName: "Noor Jahan", fromOwnerId: "usr-noor", toOwnerId: "usr-fatema", toOwnerName: "Fatema Begum", requestedById: "usr-noor", requestedAt: new Date("2026-09-12T11:00:00Z"), documentIds: [], objections: [], fee: { amount: 5400, currency: "BDT" }, deedNumber: "3892/2026", deedDate: new Date("2026-09-11T00:00:00Z"), metadata: {}, createdAt: new Date("2026-09-12T11:00:00Z"), updatedAt: new Date("2026-09-12T11:00:00Z") },
      // Habib: Partition with partition note
      { id: "m-d5-1", mutationNumber: "MUT-2026-01243", parcelId: "p-d5-1", parcelDagNo: "BS-401", type: "partition", status: "submitted", fromOwnerName: "Habib Molla", fromOwnerId: "usr-habib", toOwnerId: "usr-rashed", toOwnerName: "Rashed Khan", requestedById: "usr-habib", requestedAt: new Date("2026-09-14T10:00:00Z"), documentIds: [], objections: [], fee: { amount: 5400, currency: "BDT" }, metadata: { partitionNote: "Dividing 95 decimals equally between Habib Molla and Rashed Khan. Each to receive 47.5 decimals per the family agreement signed 2026-09-13." }, createdAt: new Date("2026-09-14T10:00:00Z"), updatedAt: new Date("2026-09-14T10:00:00Z") },
